...
/**
 * This is the item provider adapter for a {@link metaModel.Signature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignatureItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Signature_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Signature_id_feature",
								"_UI_Signature_type"),
						MetaModelPackage.Literals.SIGNATURE__ID, true, false, false,
	...
	protected void addSignaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Signature_signature_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Signature_signature_feature",
								"_UI_Signature_type"),
						MetaModelPackage.Literals.SIGNATURE__SIGNATURE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		byte[] labelValue = ((Signature) object).getId();
