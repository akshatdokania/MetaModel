...
/**
 * This is the item provider adapter for a {@link metaModel.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetaModelPackage.Literals.USER__ADDRESS, true, false, true, null, null, null));
	}
	...
	protected void addWalletPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_User_wallet_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_User_wallet_feature", "_UI_User_type"),
						MetaModelPackage.Literals.USER__WALLET, true, false, true, null, null, null));
	}
	...
	protected void addTransactionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_User_transaction_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_User_transaction_feature",
								"_UI_User_type"),
						MetaModelPackage.Literals.USER__TRANSACTION, true, false, true, null, null, null));
	}
